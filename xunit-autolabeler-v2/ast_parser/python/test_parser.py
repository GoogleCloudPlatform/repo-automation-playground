...
def get_test_methods(test_path: str) -> List[Any]:
    ...
    try:
        with open(test_path, 'r') as file:
            ...
            parsed_nodes = [node for node in parsed_nodes]
...
def get_test_key_to_snippet_map(
    ...
    Returns: a mapping between test keys and their corresponding test data
    """
...
def store_tests_on_methods(
    ...
    with their tests. That test data is then added to the
    methods themselves by updating their "drift.test_methods"
    property.
